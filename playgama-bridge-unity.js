...
function initializeBridge() {
    ...
    bridge
        ...
        .then(() => {
            ...
            unityLoader.src = 'Build/Build Prod GB 4.loader.js'
            unityLoader.onload = () => {
                createUnityInstance(
                    CANVAS,
                    {
                        dataUrl: 'Build/Build Prod GB 4.data.unityweb',
                        frameworkUrl: 'Build/Build Prod GB 4.framework.js.unityweb',
                        codeUrl: 'Build/Build Prod GB 4.wasm.unityweb',
