...
function initializeBridge() {
    ...
    bridge
        ...
        .then(() => {
            ...
            unityLoader.src = 'Build/Build GitHub 11.loader.js'
            unityLoader.onload = () => {
                createUnityInstance(
                    CANVAS,
                    {
                        dataUrl: 'Build/Build GitHub 11.data.unityweb',
                        frameworkUrl: 'Build/Build GitHub 11.framework.js.unityweb',
                        codeUrl: 'Build/Build GitHub 11.wasm.unityweb',
