...
function initializeBridge() {
    ...
    bridge
        ...
        .then(() => {
            ...
            unityLoader.src = 'Build/Build 4.loader.js'
            unityLoader.onload = () => {
                createUnityInstance(
                    CANVAS,
                    {
                        dataUrl: 'Build/Build 4.data.unityweb',
                        frameworkUrl: 'Build/Build 4.framework.js.unityweb',
                        codeUrl: 'Build/Build 4.wasm.unityweb',
