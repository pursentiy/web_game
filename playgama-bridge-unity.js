...
function initializeBridge() {
    ...
    bridge
        ...
        .then(() => {
            ...
            unityLoader.src = 'Build/Build 5.loader.js'
            unityLoader.onload = () => {
                createUnityInstance(
                    CANVAS,
                    {
                        dataUrl: 'Build/Build 5.data.unityweb',
                        frameworkUrl: 'Build/Build 5.framework.js.unityweb',
                        codeUrl: 'Build/Build 5.wasm.unityweb',
