...
function initializeBridge() {
    ...
    bridge
        ...
        .then(() => {
            ...
            unityLoader.src = 'Build/Build 1.loader.js'
            unityLoader.onload = () => {
                createUnityInstance(
                    CANVAS,
                    {
                        dataUrl: 'Build/Build 1.data.unityweb',
                        frameworkUrl: 'Build/Build 1.framework.js.unityweb',
                        codeUrl: 'Build/Build 1.wasm.unityweb',
