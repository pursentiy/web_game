...
function initializeBridge() {
    ...
    bridge
        ...
        .then(() => {
            ...
            unityLoader.src = 'Build/Build 3.loader.js'
            unityLoader.onload = () => {
                createUnityInstance(
                    CANVAS,
                    {
                        dataUrl: 'Build/Build 3.data.unityweb',
                        frameworkUrl: 'Build/Build 3.framework.js.unityweb',
                        codeUrl: 'Build/Build 3.wasm.unityweb',
