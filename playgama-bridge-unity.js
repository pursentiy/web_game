...
function initializeBridge() {
    ...
    bridge
        ...
        .then(() => {
            ...
            unityLoader.src = 'Build/Build GitHub 3.loader.js'
            unityLoader.onload = () => {
                createUnityInstance(
                    CANVAS,
                    {
                        dataUrl: 'Build/Build GitHub 3.data.unityweb',
                        frameworkUrl: 'Build/Build GitHub 3.framework.js.unityweb',
                        codeUrl: 'Build/Build GitHub 3.wasm.unityweb',
