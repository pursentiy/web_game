...
function initializeBridge() {
    ...
    bridge
        ...
        .then(() => {
            ...
            unityLoader.src = 'Build/Build Prod GB 5.loader.js'
            unityLoader.onload = () => {
                createUnityInstance(
                    CANVAS,
                    {
                        dataUrl: 'Build/Build Prod GB 5.data.unityweb',
                        frameworkUrl: 'Build/Build Prod GB 5.framework.js.unityweb',
                        codeUrl: 'Build/Build Prod GB 5.wasm.unityweb',
