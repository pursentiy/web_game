...
function initializeBridge() {
    ...
    bridge
        ...
        .then(() => {
            ...
            unityLoader.src = 'Build/Build GitHub 2.loader.js'
            unityLoader.onload = () => {
                createUnityInstance(
                    CANVAS,
                    {
                        dataUrl: 'Build/Build GitHub 2.data.unityweb',
                        frameworkUrl: 'Build/Build GitHub 2.framework.js.unityweb',
                        codeUrl: 'Build/Build GitHub 2.wasm.unityweb',
