...
function initializeBridge() {
    ...
    bridge
        ...
        .then(() => {
            ...
            unityLoader.src = 'Build/Build Prod GB 13.loader.js'
            unityLoader.onload = () => {
                createUnityInstance(
                    CANVAS,
                    {
                        dataUrl: 'Build/Build Prod GB 13.data.unityweb',
                        frameworkUrl: 'Build/Build Prod GB 13.framework.js.unityweb',
                        codeUrl: 'Build/Build Prod GB 13.wasm.unityweb',
