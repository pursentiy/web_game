...
function initializeBridge() {
    ...
    bridge
        ...
        .then(() => {
            ...
            unityLoader.src = 'Build/Build Prod Yandex 1.loader.js'
            unityLoader.onload = () => {
                createUnityInstance(
                    CANVAS,
                    {
                        dataUrl: 'Build/Build Prod Yandex 1.data.unityweb',
                        frameworkUrl: 'Build/Build Prod Yandex 1.framework.js.unityweb',
                        codeUrl: 'Build/Build Prod Yandex 1.wasm.unityweb',
