...
function initializeBridge() {
    ...
    bridge
        ...
        .then(() => {
            ...
            unityLoader.src = 'Build/Build GitHub 1.loader.js'
            unityLoader.onload = () => {
                createUnityInstance(
                    CANVAS,
                    {
                        dataUrl: 'Build/Build GitHub 1.data.unityweb',
                        frameworkUrl: 'Build/Build GitHub 1.framework.js.unityweb',
                        codeUrl: 'Build/Build GitHub 1.wasm.unityweb',
