...
function initializeBridge() {
    ...
    bridge
        ...
        .then(() => {
            ...
            unityLoader.src = 'Build/Build GitHub 10.loader.js'
            unityLoader.onload = () => {
                createUnityInstance(
                    CANVAS,
                    {
                        dataUrl: 'Build/Build GitHub 10.data.unityweb',
                        frameworkUrl: 'Build/Build GitHub 10.framework.js.unityweb',
                        codeUrl: 'Build/Build GitHub 10.wasm.unityweb',
